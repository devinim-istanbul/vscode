...
import { editorErrorFileExplorer, editorWarningFileExplorer  } from 'vs/editor/common/view/editorColorRegistry';
...
class MarkersDecorationsProvider implements IDecorationsProvider {
	...
	provideDecorations(resource: URI): IDecorationData {
		...
		return {
			...
			color: first.severity === MarkerSeverity.Error ? editorErrorFileExplorer : editorWarningFileExplorer,
		};
	}
}
